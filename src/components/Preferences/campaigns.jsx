    ...
    note: (
      <>
        <p>
          The
          {' '}
          <a href="https://ou.edu/sfc" target="_blank" rel="noreferrer">
    ...
    note: (
      <>
        <p>
          The
          {' '}
          <a href="https://ou.edu/moneycoach" target="_blank" rel="noreferrer">
    ...
    note: (
      <>
        <p>
          The
          {' '}
          <a href="https://ou.edu/registrar" target="_blank" rel="noreferrer">
